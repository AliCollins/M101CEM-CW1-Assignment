...
\newacronym{x}{X}{Lockhart-Martinelli Number}
...
\thanks{alistair.collins@ametek.com}}
...
\IEEEPARstart{V}{enturi} flow meters are an industrially proven technology for the metering of multiphase wet gas flow. Although Venturi wet gas correction methods originally borrowed from orifice plate corrections (for example, those by Murdock\cite{Murdock1962Two-PhaseOrifices} and Chisholm\cite{Chisholm1977}) de Leeuw\cite{DeLeeuw1997} provided an "empirical correlation...which accurately predicts the effect of the liquid phase on venturi meter readings in wet gas horizontal flow."



\subsection{Subsection Heading Here}
Subsection text here.
Reference to \cite{Gajan2015}
...
is a Development Engineer for Solartron~ISA (Ametek Oil \& Gas) since 2005, who manufacture the Dualstream range of wet gas flow meters.
