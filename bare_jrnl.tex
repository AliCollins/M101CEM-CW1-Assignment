...
The natural conclusion of these analyses is that the formulation in the ISO Technical Report is unable to adequately represent the effect of meter size.  However, the proviso to that is the limitations of the Solartron ISA database, as it is possible - although unlikely - that with a downstream tapping at $6D$ this formulation would work.
...
Similarly, by evaluating data from a nominal 6" $0.55\beta$ at one gas density and gas flow rate for a number of water liquid ratios, as shown in figure \ref{fig:6inch0.55Wet}, a similar comparison between the PLR data and the ISO results are shown. Similar scaling is possible to provide greater alignment, although this is not shown in this figure.  However, it is apparent from the figure that the ISO/TR~11583:2012 formulation is not as good at the relative positioning of the intermediate water-liquid ratio data, as per the criticisms of \cite{DeLeeuw2011}.
